  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 w-full max-w-[100vw] overflow-x-hidden">
        <div className="mx-auto flex h-20 min-w-0 max-w-[100vw] items-center justify-between gap-2 px-3 sm:h-24 sm:gap-3 sm:px-4 lg:px-8 bg-gradient-to-r from-slate-800 via-slate-900 to-slate-800 border-b border-slate-700/50 shadow-lg backdrop-blur-sm navbar-header-container">
